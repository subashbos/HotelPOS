        ...
        public async Task LoadDataAsync()
        {
            ...
            try
            {
                ...
                using (var scope = App.CreateDbScope())
                {
                    ...
                    hotelGstin = (await settingService.GetSettingsAsync()).HotelGst;
                }
                ...
                var rows = GstR1RowBuilder.BuildRows(b2bOrders, hotelGstin)
                    .OrderBy(r => r.Date)
                ...
                _b2cSummary = GstR1RowBuilder.BuildB2cSummary(b2cOrders, hotelGstin);
                ...
                _hsnSummary = GstR1RowBuilder.BuildHsnSummary(dateFilteredList, catalogById, hotelGstin);
