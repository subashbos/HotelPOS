        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    AnnualQuota = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Uan = table.Column<string>(type: "nvarchar(22)", maxLength: 22, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaidDays = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    LopDays = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    LopAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    EsiEmployee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    EsiEmployer = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Reception, reservations and guest services", "Front Office" },
                    { 2, "Room upkeep and laundry", "Housekeeping" },
                    { 3, "Restaurant, bar and kitchen service", "Food & Beverage" },
                    { 4, "Culinary production", "Kitchen" },
                    { 5, "Management and back office", "Administration" }
                });

            migrationBuilder.InsertData(
                table: "LeaveTypes",
                columns: new[] { "Id", "AnnualQuota", "CarryForwardAllowed", "Code", "IsPaid", "Name" },
                values: new object[,]
                {
                    { 1, 12m, false, "CL", true, "Casual Leave" },
                    { 2, 12m, false, "SL", true, "Sick Leave" },
                    { 3, 15m, true, "EL", true, "Earned / Privilege Leave" },
                    { 4, 182m, false, "ML", true, "Maternity Leave" },
                    { 5, 0m, false, "LWP", false, "Leave Without Pay" }
                });
