...
namespace HotelPOS.Application.UseCases
{
    public class UnitOfMeasurementService : IUnitOfMeasurementService
    {
        ...
        public async Task<List<UnitOfMeasurement>> GetUnitsAsync()
        {
            ...
            return await _repo!.GetAllAsync() ?? new List<UnitOfMeasurement>(); // NOSONAR
        }
        ...
        public async Task<int> AddUnitAsync(string name, int displayOrder = 0)
        {
            ...
            var existing = await _repo!.GetAllAsync() ?? new List<UnitOfMeasurement>(); // NOSONAR
        ...
        public async Task DeleteUnitAsync(int id)
        {
            ...
            var items = await _itemRepo!.GetAllAsync() ?? new List<Item>(); // NOSONAR
            ...
            await _repo!.DeleteAsync(id); // NOSONAR
        }
    }
}
